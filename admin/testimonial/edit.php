                            ...
                            <div class="col-xxl">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        $message = $image = $name = $profession = $status = "";
                                        ...
                                        if (isset($_POST['save'])) {
                                            ...
                                            if ($message != "" && $name != "" && $profession != "" && $status != "") {
                                                $update = "UPDATE testimonial SET message='$message', image='$image', name='$name', profession='$profession', status='$status' WHERE id=$id";
                                        ...
                                        <form class="row" method="POST" enctype="multipart/form-data" action="">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                <label class="col-form-label" for="basic-icon-default-profession">Profession</label>
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        <span id="basic-icon-default-profession2" class="input-group-text"></span>
                                                        <input type="text" name="profession" class="form-control" id="basic-icon-default-profession" placeholder="Enter profession" aria-label="Enter profession" aria-describedby="basic-icon-default-profession2" value="<?php echo $profession; ?>" />
                                                    </div>
                                                </div>
                                            </div>
