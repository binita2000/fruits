                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        if (isset($_POST['save'])) {
                                            ...
                                            if ($message != "" && $image != "" && $name != "" && $position !="") {
                                                $insert = "INSERT INTO testimonial (message, image,  name, position) 
                                                VALUES ('$message', '$image', '$name','$position')";
                                        ...
                                        <form class="row" method="POST" enctype="multipart/form-data" action="">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                                                <label class="col-form-label" for="basic-icon-default-image">position</label>
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        <span id="basic-icon-default-image2" class="input-group-text"></span>
                                                        <input type="text" name="position" class="form-control" id="basic-icon-default-image" placeholder="Enter position" aria-label="" aria-describedby="basic-icon-default-image2" />
                                                    </div>
                                                </div>
                                            </div>
