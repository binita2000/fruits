      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
            <h5 class="card-header"><a class="btn btn-primary btn-sm " href="create.php" role="button"> Add Users</a></h5>
                ...
                <table class="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                      ...
                      <td><?php echo .phpspecialchars($data['username']); ?></td>
                      <td><?php echo .phpspecialchars($data['phone']); ?></td>
                      <td><?php echo .phpspecialchars($data['email']); ?></td>
                      <td><?php echo .phpspecialchars($data['password']); ?></td>
                      <td><?php echo .phpspecialchars($data['role']); ?></td>
                      <td><?php echo .phpspecialchars($data['status'] == 1) ? 'Active' : 'In-Active'; ?></td>
                      <td>
                        <div class="dropdown">
