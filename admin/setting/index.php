            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">settings /</span>Manage settings Sections</h4>
                            ...
                            <div class="table-responsive text-nowrap">
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <?php
                                        $select = "SELECT * FROM settings ORDER BY id ASC";
                                        ...
                                        while ($data = mysqli_fetch_array($select_result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($data['site_key']); ?></td>
                                                <td><?php echo htmlspecialchars($data['site_value']); ?></td>
                                                <td><?php echo htmlspecialchars($data['status'] == 1 ? 'Active' : 'Inactive'); ?></td>
                                                <td>
                                                    <div class="dropdown">
