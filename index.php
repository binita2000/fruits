...
>>>>>>> 7a2530a6d873a8cb1f7865d8d30e4c4028e3b186
                                        ...
                                        <div class="p-4 rounded-bottom">
                                            ...
                                            <p class="text-dark fs-5 fw-bold mb-0">Rs <?php echo $category_data['price'] ?> /
                                                kg</p>
    ...
    <div class="container-fluid vesitable py-5">
        <div class="container py-5">
            ...
            <div class="owl-carousel vegetable-carousel justify-content-center">
                ...
                <?php
                $categories = "SELECT *FROM categories";
                $cat_result = mysqli_query($conn, $categories);
                while ($cat_data = mysqli_fetch_array($cat_result)) {
                ?>
                    <div class="border border-primary rounded position-relative vesitable-item">
                        <div class="fruite-img">
                            <img src="<?php echo 'admin/uploads/' . $cat_data['image']; ?>" class="img-fluid w-100 rounded-top" alt="">
                        </div>
                        <div class="p-4 rounded-bottom">
    ...
    <div class="container-fluid vesitable pb-5">
        <div class="container py-5">
            ...
            <div class="owl-carousel vegetable-carousel justify-content-center">
                ...
                $cate_result = mysqli_query($conn, $cate);
                while ($cate_data = mysqli_fetch_array($cate_result)) {
                ?>
                    <div class="border border-primary rounded position-relative vesitable-item">
                        <div class="fruite-img">
                            <img src="<?php echo 'admin/uploads/' . $cate_data['image']; ?>" class="img-fluid w-100 rounded-top" alt="">
                        </div>
                        <div class="p-4 rounded-bottom">
                            <h4><?php echo $cate_data['title'] ?></h4>
                            <div class="description">
