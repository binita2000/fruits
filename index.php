                            ...
                            <div class="col-lg-12">
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="img/Making-curd.jpg" class="img-fluid w-100 rounded-top" alt="">
                                            </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <img src="img/paneer.jpg" class="img-fluid w-100 rounded-top" alt="">
                                            </div>
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Dairy Product</div>
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                <h4>Paneer</h4>
        ...
        <div class="container py-5">
            ...
            <div class="owl-carousel vegetable-carousel justify-content-center">
                ...
                <div class="border border-primary rounded position-relative vesitable-item">
                    ...
                    <div class="text-white bg-primary px-3 py-1 rounded position-absolute" style="top: 10px; right: 10px;">Dairy Product</div>
                    <div class="p-4 rounded-bottom">
                        <h4>curd</h4>
                        <div class="description">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
